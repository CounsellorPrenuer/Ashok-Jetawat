...
const projectId = process.env.SANITY_PROJECT_ID || "a1ht83cx";
...
const documents = [
  ...
  },
  {
    ...
    quote: "Dr. Ashok Jetawat helped me choose the right stream after Class 10. The psychometric assessment was eye-opening and the counselling sessions gave me clarity.",
    rating: 5, image: careerImage, order: 1,
  },
  {
    _id: "testimonial-2", _type: "testimonials", name: "Arjun Mehta", role: "College Graduate",
    quote: "The guidance on college selection and profile building was invaluable. I got into my dream university thanks to their strategic advice.",
    rating: 5, image: streamImage, order: 2,
  },
  {
    _id: "testimonial-3", _type: "testimonials", name: "Sneha Reddy", role: "Working Professional",
    quote: "The career transition counselling helped me pivot with confidence. Highly recommend Asian Counselling Center!",
  ...
  },
  {
    ...
    author: "Dr. Ashok Jetawat", publishedAt: "2026-06-01T09:00:00.000Z", featured: true, image: blogImage,
    body: [
  ...
  },
  {
    ...
    author: "Dr. Ashok Jetawat", publishedAt: "2026-05-15T09:00:00.000Z", featured: false, image: collegeImage,
    body: [
  ...
  },
  {
    ...
    author: "Dr. Ashok Jetawat", publishedAt: "2026-05-01T09:00:00.000Z", featured: false, image: profileImage,
    body: [
...
console.log(`Seeded ${documents.length} Sanity documents for Ashok Jetawat.`);
