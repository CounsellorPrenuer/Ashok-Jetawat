-- Future coupon template for ashokjetawat (NOT active — do not run unless adding coupons)
...
-- VALUES
--   ('YOURCODE', 'percentage', 10, 0, NULL, 1, NULL, 'ashokjetawat', 'ashokjetawat-YOURCODE', 10);
