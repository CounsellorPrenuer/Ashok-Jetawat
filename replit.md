...
- Enhanced Blog section with category-specific icons: Users icon for Leadership, Flower2 icon (yoga/wellness) for Wellness, BookOpen icon for Education, all centered in gradient image areas with hover effects
