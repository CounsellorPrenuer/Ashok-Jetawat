...
export const CMS_FALLBACK: CmsContent = {
  ...
  testimonials: [
    { _id: "fallback-testimonial-1", name: "Priya Sharma", role: "Class 12 Student", quote: "Dr. Ashok Jetawat helped me choose the right stream after Class 10. The psychometric assessment was eye-opening and the counselling sessions gave me clarity.", rating: 5 },
    { _id: "fallback-testimonial-2", name: "Arjun Mehta", role: "College Graduate", quote: "The guidance on college selection and profile building was invaluable. I got into my dream university thanks to their strategic advice.", rating: 5 },
    { _id: "fallback-testimonial-3", name: "Sneha Reddy", role: "Working Professional", quote: "The career transition counselling helped me pivot with confidence. Highly recommend Asian Counselling Center!", rating: 5 },
  ],
  services: [
